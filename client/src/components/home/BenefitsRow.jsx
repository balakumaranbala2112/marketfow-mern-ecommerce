...
const benefits = [
  { icon: "ShieldCheck", title: "Secure Payment", desc: "100% secure payment", color: "text-emerald-600" },
  { icon: "RotateCcw", title: "Easy Returns", desc: "30-day return policy", color: "text-primary-600" },
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {benefits.map((b) => {
            ...
            return (
              ...
              >
                <div className={`shrink-0 flex h-11 w-11 items-center justify-center rounded-xl bg-gray-50 ${b.color} transition-colors group-hover:bg-primary-50`}>
                  <Icon size={20} strokeWidth={1.5} />
                </div>
                <div className="min-w-0">
                  <h4 className="text-sm font-bold text-gray-900 tracking-tight">{b.title}</h4>
